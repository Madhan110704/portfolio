// Brand icon SVG components — lucide-react doesn't include brand icons
...
export function WhatsAppIcon({ size = 18, className = '', style = {} }: { size?: number; className?: string; style?: React.CSSProperties }) {
  return (
    <svg
      width={size}
      height={size}
